    ...
    return (
      <div style={styles.detailBox}>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <select value={currentCenter} onChange={(e) => setSelectedCenter(e.target.value)} style={styles.select}>
        ...
        {currentCenterInfo && (
          <div style={styles.centerBox}>
            ...
            </div>import React, { useEffect, useMemo, useState, useDeferredValue } from "react";
import Papa from "papaparse";
import * as XLSX from "xlsx";
