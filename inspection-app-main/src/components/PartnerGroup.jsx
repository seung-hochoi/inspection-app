...
export default function PartnerGroup({
  ...
  drafts = {}, saveStatuses = {},
  searchQuery = '',
  centers = [], happycallRanks = {}, eventSet = new Set(),
  onDraftChange, onSaved, onMovementSaved, onError,
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          {totalCount > 0 && (
            <div style={{ width: 52, height: 3, background: C.bgAlt, borderRadius: radius.full, overflow: 'hidden' }}>
              <div style={{
            ...
            {visibleRows.map((r) => {
              ...
              return (
                <ProductRow
                  ...
                  isEvent={eventSet.has(normalizeCode(r['상품코드']))}
