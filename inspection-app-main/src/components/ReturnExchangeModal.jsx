 ...
 *   onClose()
 */
export default function ReturnExchangeModal({ product, jobKey, initialType, centers = [], onSave, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Qty */}
        <div style={{ marginBottom: 14 }}>
          <label style={labelStyle}>{typeLabel} 수량 * {product.orderedQty ? `(발주: ${product.orderedQty})` : ''}</label>
          <input
            style={fieldStyle}
